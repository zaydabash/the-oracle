...
from ...schemas.signal_event import SignalEventResponse, SignalEventFilter, SignalEventList
...
async def list_signal_events(
    ...
    min_magnitude: Optional[float] = Query(None, ge=0, description="Minimum magnitude filter"),
