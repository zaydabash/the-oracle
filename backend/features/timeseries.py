...
class TimeSeriesAnalyzer:
    ...
    Extracts quantitative features from signal events including:
    - Velocity: Rate of change using exponential weighted moving average
    - Acceleration: Second derivative of velocity
    - Convergence: Cross-source signal alignment over time
    - Z-spike: Statistical anomaly detection using z-scores
    
    These features are used as inputs to the forecasting engine.
    """
    ...
    def __init__(self, window_size: int = 7, alpha: float = 0.3):
        ...
        Args:
            ...
            alpha: Smoothing factor for exponential weighted moving average
        """
