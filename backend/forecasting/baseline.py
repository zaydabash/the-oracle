...
class BaselineForecaster:
    ...
    def _generate_forecast(self, features_data: pd.DataFrame, horizon_days: int) -> Optional[Dict]:
    ...
    def _fit_arima_model(self, series: pd.Series, horizon_days: int) -> Optional[Dict]:
    ...
    def _fit_exponential_smoothing_model(self, series: pd.Series, horizon_days: int) -> Optional[Dict]:
    ...
    def _fit_simple_trend_model(self, series: pd.Series, horizon_days: int) -> Optional[Dict]:
