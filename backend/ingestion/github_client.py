...
class GitHubClient:
    ...
    def fetch_trending_repos(self, days: int = 7, language: str | None = None) -> list[dict[str, Any]]:
    ...
    def _fetch_live_trending(self, days: int, language: str | None) -> list[dict[str, Any]]:
    ...
    def _parse_github_repo(self, repo_data: dict[str, Any]) -> dict[str, Any] | None:
    ...
    def search_repositories(self, query: str, language: str | None = None, max_results: int = 50) -> list[dict[str, Any]]:
