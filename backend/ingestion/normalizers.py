...
class SignalEventNormalizer:
    ...
    def normalize_arxiv_paper(self, paper: Dict[str, Any]) -> Optional[SignalEvent]:
    ...
    def normalize_github_repo(self, repo: Dict[str, Any]) -> Optional[SignalEvent]:
    ...
    def normalize_job_posting(self, job: Dict[str, Any]) -> Optional[SignalEvent]:
    ...
    def normalize_funding_round(self, funding: Dict[str, Any]) -> Optional[SignalEvent]:
